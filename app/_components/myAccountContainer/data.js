export const profileData = [
	{
		...
		icon: (
			<svg
				...
				<path
					d='M14.6668 16V14.6667C14.6668 13.9594 14.3859 13.2811 13.8858 12.781C13.3857 12.281 12.7074 12 12.0002 12H8.00016C7.29292 12 6.61464 12.281 6.11454 12.781C5.61445 13.2811 5.3335 13.9594 5.3335 14.6667V16'
					stroke='currentColor'
					strokelinecapp='round'
					strokeLinejoin='round'
				/>
				<path
					d='M10.0002 9.33333C11.4729 9.33333 12.6668 8.13943 12.6668 6.66667C12.6668 5.19391 11.4729 4 10.0002 4C8.5274 4 7.3335 5.19391 7.3335 6.66667C7.3335 8.13943 8.5274 9.33333 10.0002 9.33333Z'
					stroke='currentColor'
					strokelinecapp='round'
					strokeLinejoin='round'
				/>
	...
	},
	{
		...
		icon: (
			<svg
				...
				/>
				<path
					d='M10.6668 6.6665C10.6668 7.37375 10.3859 8.05203 9.88578 8.55212C9.38568 9.05222 8.70741 9.33317 8.00016 9.33317C7.29292 9.33317 6.61464 9.05222 6.11454 8.55212C5.61445 8.05203 5.3335 7.37375 5.3335 6.6665'
					stroke='currentColor'
					strokelinecapp='round'
					strokeLinejoin='round'
				/>
	...
	},
	{
		...
		icon: (
			<svg
				...
				fill='none'
				xmlns='http://www.w3.org/2000/svg'>
				<g clipPath='url(#clip0_1291_11943)'>
					<path
					...
					/>
					<path
						d='M10.6668 5.3335H6.66683C6.31321 5.3335 5.97407 5.47397 5.72402 5.72402C5.47397 5.97407 5.3335 6.31321 5.3335 6.66683C5.3335 7.02045 5.47397 7.35959 5.72402 7.60964C5.97407 7.85969 6.31321 8.00016 6.66683 8.00016H9.3335C9.68712 8.00016 10.0263 8.14064 10.2763 8.39069C10.5264 8.64074 10.6668 8.97987 10.6668 9.3335C10.6668 9.68712 10.5264 10.0263 10.2763 10.2763C10.0263 10.5264 9.68712 10.6668 9.3335 10.6668H5.3335'
						stroke='currentColor'
						strokelinecapp='round'
						strokeLinejoin='round'
					/>
